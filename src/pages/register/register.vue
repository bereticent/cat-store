    ...
    <div class="loagin">
      ...
      <div class="main">
        ...
        <div class="other_login">
          <div class="ZFB">
            <a href="#">
              <img src="./imgs/login_ico2.png" alt="">
            </a>
          </div>
          <div class="QQ">
            <a href="#">
              <img src="./imgs/login_ico4.png" alt="">
            </a>
          </div>
        </div>
      </div>
  ...
  .header
    ...
    .header-top
      ...
      .arrow
        ...
        position: absolute;
        margin-top: 16px;
        background: url('./imgs/personal-bico3.png') no-repeat;
        ...
        ul
          ...
          li
            ...
            .numico
              ...
              width: 17px;
              height: 17px;
              background: url('./imgs/ico1.png') no-repeat;
              background-size: contain;
              margin: 1px 0 0 -25px;
            .passwordico
              float: left;
